...
echo -e " ${BLUE}(2)${NC}  Fresh build & start development server (detached)"
...
echo -e " ${BLUE}(8)${NC}  Start test server (detached)"
echo -e " ${BLUE}(9)${NC}  Fresh build & start test server (detached)"
