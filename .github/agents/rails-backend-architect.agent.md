...
design/optimization, Rails model/controller/service implementation, background: ''
job setup, caching strategy, API design, performance optimization, SOLID: ''
violations, ActiveRecord queries, Redis integration, database migrations, test: ''
coverage for backend logic.: ''
