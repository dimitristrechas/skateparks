...
6. `sh scripts.sh`, option 1 builds the docker image from scratch, option 2 runs existing
7. Open another terminal and run `rails tailwindcss:watch` to build tailwind css
8. `localhost:3000`
