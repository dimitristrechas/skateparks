...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y build-essential curl git libpq-dev libvips node-gyp pkg-config python-is-python3 redis-tools
...
# Change permissions of the /rails/public
RUN chown -R 1000:1000 /rails/public
